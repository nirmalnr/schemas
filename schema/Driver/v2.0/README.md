...
| File | Purpose |
|---|---|
| [https://schema.nfh.global/Driver/attributes.yaml](https://schema.nfh.global/Driver/attributes.yaml) | OpenAPI schema envelope (latest path) |
...
| [https://schema.nfh.global/Driver/attributes.jsonschema.yaml](https://schema.nfh.global/Driver/attributes.jsonschema.yaml) | JSON Schema document (latest path) |
...
| [https://schema.nfh.global/Driver/context.jsonld](https://schema.nfh.global/Driver/context.jsonld) | JSON-LD context (latest path) |
...
| [https://schema.nfh.global/Driver/vocab.jsonld](https://schema.nfh.global/Driver/vocab.jsonld) | RDF vocabulary (latest path) |
