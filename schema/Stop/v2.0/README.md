...
| File | Purpose |
|---|---|
| [https://schema.nfh.global/Stop/attributes.yaml](https://schema.nfh.global/Stop/attributes.yaml) | OpenAPI schema envelope (latest path) |
...
| [https://schema.nfh.global/Stop/attributes.jsonschema.yaml](https://schema.nfh.global/Stop/attributes.jsonschema.yaml) | JSON Schema document (latest path) |
...
| [https://schema.nfh.global/Stop/context.jsonld](https://schema.nfh.global/Stop/context.jsonld) | JSON-LD context (latest path) |
...
| [https://schema.nfh.global/Stop/vocab.jsonld](https://schema.nfh.global/Stop/vocab.jsonld) | RDF vocabulary (latest path) |
