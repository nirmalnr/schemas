...
| File | Purpose |
|---|---|
| [https://schema.nfh.global/FulfillmentStage/attributes.yaml](https://schema.nfh.global/FulfillmentStage/attributes.yaml) | OpenAPI schema envelope (latest path) |
...
| [https://schema.nfh.global/FulfillmentStage/attributes.jsonschema.yaml](https://schema.nfh.global/FulfillmentStage/attributes.jsonschema.yaml) | JSON Schema document (latest path) |
...
| [https://schema.nfh.global/FulfillmentStage/context.jsonld](https://schema.nfh.global/FulfillmentStage/context.jsonld) | JSON-LD context (latest path) |
...
| [https://schema.nfh.global/FulfillmentStage/vocab.jsonld](https://schema.nfh.global/FulfillmentStage/vocab.jsonld) | RDF vocabulary (latest path) |
