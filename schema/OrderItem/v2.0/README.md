...
| File | Purpose |
|---|---|
| [https://schema.nfh.global/OrderItem/attributes.yaml](https://schema.nfh.global/OrderItem/attributes.yaml) | OpenAPI schema envelope (latest path) |
...
| [https://schema.nfh.global/OrderItem/attributes.jsonschema.yaml](https://schema.nfh.global/OrderItem/attributes.jsonschema.yaml) | JSON Schema document (latest path) |
...
| [https://schema.nfh.global/OrderItem/context.jsonld](https://schema.nfh.global/OrderItem/context.jsonld) | JSON-LD context (latest path) |
...
| [https://schema.nfh.global/OrderItem/vocab.jsonld](https://schema.nfh.global/OrderItem/vocab.jsonld) | RDF vocabulary (latest path) |
