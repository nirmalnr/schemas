...
| File | Purpose |
|---|---|
| [https://schema.nfh.global/Fare/attributes.yaml](https://schema.nfh.global/Fare/attributes.yaml) | OpenAPI schema envelope (latest path) |
...
| [https://schema.nfh.global/Fare/attributes.jsonschema.yaml](https://schema.nfh.global/Fare/attributes.jsonschema.yaml) | JSON Schema document (latest path) |
...
| [https://schema.nfh.global/Fare/context.jsonld](https://schema.nfh.global/Fare/context.jsonld) | JSON-LD context (latest path) |
...
| [https://schema.nfh.global/Fare/vocab.jsonld](https://schema.nfh.global/Fare/vocab.jsonld) | RDF vocabulary (latest path) |
