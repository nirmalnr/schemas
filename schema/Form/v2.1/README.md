...
| File | Purpose |
|---|---|
| [https://schema.nfh.global/Form/attributes.yaml](https://schema.nfh.global/Form/attributes.yaml) | OpenAPI schema envelope (latest path) |
...
| [https://schema.nfh.global/Form/attributes.jsonschema.yaml](https://schema.nfh.global/Form/attributes.jsonschema.yaml) | JSON Schema document (latest path) |
...
| [https://schema.nfh.global/Form/context.jsonld](https://schema.nfh.global/Form/context.jsonld) | JSON-LD context (latest path) |
...
| [https://schema.nfh.global/Form/vocab.jsonld](https://schema.nfh.global/Form/vocab.jsonld) | RDF vocabulary (latest path) |
