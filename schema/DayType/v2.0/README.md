...
| File | Purpose |
|---|---|
| [https://schema.nfh.global/DayType/attributes.yaml](https://schema.nfh.global/DayType/attributes.yaml) | OpenAPI schema envelope (latest path) |
...
| [https://schema.nfh.global/DayType/attributes.jsonschema.yaml](https://schema.nfh.global/DayType/attributes.jsonschema.yaml) | JSON Schema document (latest path) |
...
| [https://schema.nfh.global/DayType/context.jsonld](https://schema.nfh.global/DayType/context.jsonld) | JSON-LD context (latest path) |
...
| [https://schema.nfh.global/DayType/vocab.jsonld](https://schema.nfh.global/DayType/vocab.jsonld) | RDF vocabulary (latest path) |
