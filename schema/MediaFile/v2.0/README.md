...
| File | Purpose |
|---|---|
| [https://schema.nfh.global/MediaFile/attributes.yaml](https://schema.nfh.global/MediaFile/attributes.yaml) | OpenAPI schema envelope (latest path) |
...
| [https://schema.nfh.global/MediaFile/attributes.jsonschema.yaml](https://schema.nfh.global/MediaFile/attributes.jsonschema.yaml) | JSON Schema document (latest path) |
...
| [https://schema.nfh.global/MediaFile/context.jsonld](https://schema.nfh.global/MediaFile/context.jsonld) | JSON-LD context (latest path) |
...
| [https://schema.nfh.global/MediaFile/vocab.jsonld](https://schema.nfh.global/MediaFile/vocab.jsonld) | RDF vocabulary (latest path) |
