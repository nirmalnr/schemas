...
| File | Purpose |
|---|---|
| [https://schema.nfh.global/Feed/attributes.yaml](https://schema.nfh.global/Feed/attributes.yaml) | OpenAPI schema envelope (latest path) |
...
| [https://schema.nfh.global/Feed/attributes.jsonschema.yaml](https://schema.nfh.global/Feed/attributes.jsonschema.yaml) | JSON Schema document (latest path) |
...
| [https://schema.nfh.global/Feed/context.jsonld](https://schema.nfh.global/Feed/context.jsonld) | JSON-LD context (latest path) |
...
| [https://schema.nfh.global/Feed/vocab.jsonld](https://schema.nfh.global/Feed/vocab.jsonld) | RDF vocabulary (latest path) |
