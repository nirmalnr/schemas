...
| File | Purpose |
|---|---|
| [https://schema.nfh.global/Itinerary/attributes.yaml](https://schema.nfh.global/Itinerary/attributes.yaml) | OpenAPI schema envelope (latest path) |
...
| [https://schema.nfh.global/Itinerary/attributes.jsonschema.yaml](https://schema.nfh.global/Itinerary/attributes.jsonschema.yaml) | JSON Schema document (latest path) |
...
| [https://schema.nfh.global/Itinerary/context.jsonld](https://schema.nfh.global/Itinerary/context.jsonld) | JSON-LD context (latest path) |
...
| [https://schema.nfh.global/Itinerary/vocab.jsonld](https://schema.nfh.global/Itinerary/vocab.jsonld) | RDF vocabulary (latest path) |
