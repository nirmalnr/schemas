...
Initial v2.1 release using generalised contractAttributes container.
...
- Per-schema prefix pointing to `https://schema.nfh.global/JobApplicationContract#`
