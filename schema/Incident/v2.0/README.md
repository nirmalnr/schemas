...
| File | Purpose |
|---|---|
| [https://schema.nfh.global/Incident/attributes.yaml](https://schema.nfh.global/Incident/attributes.yaml) | OpenAPI schema envelope (latest path) |
...
| [https://schema.nfh.global/Incident/attributes.jsonschema.yaml](https://schema.nfh.global/Incident/attributes.jsonschema.yaml) | JSON Schema document (latest path) |
...
| [https://schema.nfh.global/Incident/context.jsonld](https://schema.nfh.global/Incident/context.jsonld) | JSON-LD context (latest path) |
...
| [https://schema.nfh.global/Incident/vocab.jsonld](https://schema.nfh.global/Incident/vocab.jsonld) | RDF vocabulary (latest path) |
