...
| File | Purpose |
|---|---|
| [https://schema.nfh.global/Quay/attributes.yaml](https://schema.nfh.global/Quay/attributes.yaml) | OpenAPI schema envelope (latest path) |
...
| [https://schema.nfh.global/Quay/attributes.jsonschema.yaml](https://schema.nfh.global/Quay/attributes.jsonschema.yaml) | JSON Schema document (latest path) |
...
| [https://schema.nfh.global/Quay/context.jsonld](https://schema.nfh.global/Quay/context.jsonld) | JSON-LD context (latest path) |
...
| [https://schema.nfh.global/Quay/vocab.jsonld](https://schema.nfh.global/Quay/vocab.jsonld) | RDF vocabulary (latest path) |
