...
| File | Purpose |
|---|---|
| [https://schema.nfh.global/CatalogPublishResponse/attributes.yaml](https://schema.nfh.global/CatalogPublishResponse/attributes.yaml) | OpenAPI schema envelope (latest path) |
...
| [https://schema.nfh.global/CatalogPublishResponse/attributes.jsonschema.yaml](https://schema.nfh.global/CatalogPublishResponse/attributes.jsonschema.yaml) | JSON Schema document (latest path) |
...
| [https://schema.nfh.global/CatalogPublishResponse/context.jsonld](https://schema.nfh.global/CatalogPublishResponse/context.jsonld) | JSON-LD context (latest path) |
...
| [https://schema.nfh.global/CatalogPublishResponse/vocab.jsonld](https://schema.nfh.global/CatalogPublishResponse/vocab.jsonld) | RDF vocabulary (latest path) |
